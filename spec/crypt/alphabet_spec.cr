...
describe Alphabet do
  ...
  describe "#length" do
    it "returns the total amount of chars in the alphabet" do
      ROMAN.length.should eq 26

      Alphabet.new("rbwod").length.should eq 5
      Alphabet.new("jkhg").length.should  eq 4
    end
  end
  ...
  describe "#shift!" do
    ...
    it "does not transform alphabet that is initialized as final" do
      ...
      ROMAN.shift! 10 # ROMAN is declared as final in `crypt.cr`
